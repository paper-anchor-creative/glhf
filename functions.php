...
function sip_scripts() {
	wp_enqueue_style( 'sip-style', get_template_directory_uri() . '/build/style.css' );

	wp_enqueue_script( 'jquery' );

	wp_enqueue_script( 'sip-scripts', get_template_directory_uri() . '/build/scripts.js', array(), '20120206', true );
